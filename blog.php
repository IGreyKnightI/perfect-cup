        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <p>Start your morning off with this great recipe for hot coffe with coconut oil and butter.</p>
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <p>Take the edge off with a Fresh hot cup of coffe made with Irish whiskey and Irish Cream.</p>
    ...
    <div id="myModal3" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Caramel Coffee</h4>
                </div>
                <div class="modal-body">
                    <p>Sample text</p>
                </div>
